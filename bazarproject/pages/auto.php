  ...
  <div class="col-md-3">
        ...
        <div class="col-md-3">
          <form action="index.php" method="get">
			  <div class="form-row">
				  <div class="col-md-8">
                  <input type="hidden" name="link" value="auto.php">
...
<?php
	...
	if($_GET["hladaj"]) $sql = "SELECT * FROM auto WHERE PopisA LIKE '%".$_GET["hladaj"]."%'";	//ak obsahuje h�adan� re�azec
	...
	?>
        <div class="card mb-3" style="max-width: 540px;" style="max-heiht: 150px">
           <div class="row no-gutters">
            <div class="col-md-4">
            <img src="images/<?php echo $row["ObrazokA"]; ?>" class="card-img" alt="...">
            </div>
           <div class="col-md-8">
          <div class="card-body">
          <h5 class="card-title"><?php echo $row["PopisA"]; ?></a></h5>
          <p class="card-text"><?php echo $row["CenaA"]; ?></p>
          <p class="card-text"><?php echo $row["LokalitaA"]; ?></p>
          </div>
         </div>
         </div>
        </div>
