...
<?php
	...
	if($_GET["hladaj"]) $sql = "SELECT * FROM kategorie WHERE Meno LIKE '%".$_GET["hladaj"]."%'";	//ak obsahuje h�adan� re�azec
	...
	?>
        <div class="card mb-3" style="max-width: 540px;" style="max-heiht: 150px">
           <div class="row no-gutters">
            <div class="col-md-4">
            <img src="images/<?php echo $row["Obrazok"]; ?>" class="card-img" alt="...">
            </div>
           <div class="col-md-8">
          <div class="card-body">
          <h5 class="card-title"><a class="nav-link active" href="../index.php?link=<?php echo $row["Link"];?>.php"><?php echo $row["Meno"]; ?></a></h5>
          <p class="card-text"></p>
          </div>
         </div>
         </div>
